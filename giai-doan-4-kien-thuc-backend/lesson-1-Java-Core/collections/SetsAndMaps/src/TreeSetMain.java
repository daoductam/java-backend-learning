...
//        NavigableSet<Contact> sorted = new TreeSet<>(phones);
        ...
        System.out.printf("max = %s last = %s %n", min.getName(),first.getName());
        System.out.println("---------------------------");

        NavigableSet<Contact> copiedSet = new TreeSet<>(fullSet);
        System.out.println("Phần tử đầu: "+copiedSet.pollFirst());
        System.out.println("Phần tử cuối: "+copiedSet.pollLast());
        ...
        System.out.printf("Removed "+lastContact);
        descendingSet.forEach(System.out::println);
        System.out.println("-------------------------------");
        fullSet.forEach(System.out::println);
        System.out.println("-------------------------------");
